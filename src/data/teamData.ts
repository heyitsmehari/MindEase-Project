...
export const TEAM: TeamMember[] = [
    ...
    },
    {
        ...
        image: "https://i.ibb.co/ZyJQZQZ/Whats-App-Image-2026-03-12-at-16-15-45.jpg",
    ...
    },
    {
        ...
        name: 'Krishna Kumar',
        role: 'Developer ',
        desc: 'Make mood tracker and emergency helpline content, and deployment pipelines. Keeps the platform secure and performant.',
        image: "https://i.ibb.co/jPp4fWPk/IMG-20260311-WA0010.jpg",
        tags: ['Firebase', 'CI/CD', 'Security'],
        github: 'https://github.com/KrishnaKumar1506', linkedin: '#', email: '#',
        isLeader: false,
        color: '#10B981',
        light: '#D1FAE5',
    },
